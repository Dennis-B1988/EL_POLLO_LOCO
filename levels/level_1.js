const level_1 = new Level(
    ...
    [
        ...
        new BackgroundObject('./assets/img/5_background/layers/air.png', 700 * 3),
        new BackgroundObject('./assets/img/5_background/layers/3_third_layer/2.png', 700 * 3),
        new BackgroundObject('./assets/img/5_background/layers/2_second_layer/2.png', 700 * 3),
        new BackgroundObject('./assets/img/5_background/layers/1_first_layer/2.png', 700 * 3),

        new BackgroundObject('./assets/img/5_background/layers/air.png', 700 * 4),
        new BackgroundObject('./assets/img/5_background/layers/3_third_layer/1.png', 700 * 4),
        new BackgroundObject('./assets/img/5_background/layers/2_second_layer/1.png', 700 * 4),
        new BackgroundObject('./assets/img/5_background/layers/1_first_layer/1.png', 700 * 4),

        new BackgroundObject('./assets/img/5_background/layers/air.png', 700 * 5),
        new BackgroundObject('./assets/img/5_background/layers/3_third_layer/2.png', 700 * 5),
        new BackgroundObject('./assets/img/5_background/layers/2_second_layer/2.png', 700 * 5),
        new BackgroundObject('./assets/img/5_background/layers/1_first_layer/2.png', 700 * 5),

        new BackgroundObject('./assets/img/5_background/layers/air.png', 700 * 6),
        new BackgroundObject('./assets/img/5_background/layers/3_third_layer/1.png', 700 * 6),
        new BackgroundObject('./assets/img/5_background/layers/2_second_layer/1.png', 700 * 6),
        new BackgroundObject('./assets/img/5_background/layers/1_first_layer/1.png', 700 * 6),
    ],
    [
